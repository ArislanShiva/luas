    ...
    send_command('bind #1 input //send safiyeh /ma "Geo-Wilt" <t>')
    ...
    send_command('bind #q input //send safiyeh /ma "Blizzard" <t>')
    send_command('bind #w input //send safiyeh /ma "Water" <t>')
