    ...
    send_command('bind #2 input //send safiyeh /ma "Indi-Fade" <t>')
    send_command('bind #3 input //send safiyeh /ma "Indi-Haste" <t>')
    send_command('bind #4 input //send safiyeh /ma "Indi-AGI" <t>')
    ...
    send_command('bind #8 input //send safiyeh /ma "Blind" <t>')
