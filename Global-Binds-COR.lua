    ...
    send_command('bind #4 input //send safiyeh /ja "Rogue\'s Roll" <me>')
    ...
    send_command('bind #8 input //send safiyeh /ma "Light Shot" <t>')
    send_command('bind #0 input //send safiyeh /ma "Dark Shot" <t>')
    ...
    send_command('bind #f input //send safiyeh /ja "Fold" <me>')
