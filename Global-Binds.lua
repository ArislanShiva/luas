    ...
    --send_command('bind #1 input //send safiyeh /ma "Geo-Torpor" <t>')
    ...
    --send_command('bind #2 input //send safiyeh /ma "Indi-Precision" <t>')
    ...
    send_command('bind #q input //send safiyeh /ma "Fire III" <t>')
